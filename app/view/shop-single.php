    <style>
        ...
        /* Ảnh trong lưới sản phẩm liên quan */
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Trắng / Đen</strong></p>
                                </li>
                            </ul>
            ...
            <div id="carousel-related-product" class="row">
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    <li><a class="btn btn-success text-white" href="index.php?page=shop-single"><i class="far fa-heart"></i></a></li>
                                    <li><a class="btn btn-success text-white mt-2" href="index.php?page=shop-single"><i class="far fa-eye"></i></a></li>
                                    <li><a class="btn btn-success text-white mt-2" href="index.php?page=shop-single"><i class="fas fa-cart-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="index.php?page=shop-single" class="h3 text-decoration-none">Quần áo màu đỏ</a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="index.php?page=shop-single" class="h3 text-decoration-none">Áo sơ mi trắng</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="index.php?page=shop-single" class="h3 text-decoration-none">Oupidatat non</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="index.php?page=shop-single" class="h3 text-decoration-none">Thời trang đen</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
